...
TEST(HomeomorphismTest, PreservesOpenSets) {
    ...
    EXPECT_TRUE(homeomorphism.preservesOpenSets(function, space1, space2));
    EXPECT_TRUE(homeomorphism.preservesOpenSets(inverse, space2, space1));
}

TEST(HomeomorphismTest, PreservesClosedSets) {
    std::set<double> points1 = {1, 2, 3};
    std::set<std::set<double>> openSets1 = {{1}, {2}, {3}};
    topology::SpaceProperty space1(points1, openSets1);
    ...
    Homeomorphism homeomorphism(function, inverse, space1, space2);
    EXPECT_TRUE(homeomorphism.preservesClosedSets(function, space1, space2));
    EXPECT_TRUE(homeomorphism.preservesClosedSets(inverse, space2, space1));
}
